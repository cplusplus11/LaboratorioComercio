                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="detail.html">
                                                <img src="assets/img/dgp01.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="detail.html">
                                                <img src="assets/img/dgp01_01.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="text">
                                    <h3><a href="detail.html">Gallo 01</a></h3>
                                    <p class="price"><del>S/100.00</del>S/96.00</p>
                                    <p class="buttons">
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="detail.html">
                                                <img src="assets/img/dglp02.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="detail.html">
                                                <img src="assets/img/dgp02_02.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <a href="detail.html" class="invisible">
                                    <img src="assets/img/dgp02.jpg" alt="" class="img-responsive">
                                </a>
                                <div class="text">
                                    <h3><a href="detail.html">Gallo 02 Rojo</a></h3>
                                    <p class="price"><del>S/100.00</del> S/96.00</p>
                                    <p class="buttons">
                                        <a href="detail.html" class="btn btn-default">Ver Detalles</a>
                                        <a href="basket.html" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Agregar</a>
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="detail.html">
                                                <img src="assets/img/dgp03.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="detail.html">
                                                <img src="assets/img/dgp03_03.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <a href="detail.html" class="invisible">
                                    <img src="assets/img/dfp03.jpg" alt="" class="img-responsive">
                                </a>
                                <div class="text">
                                    <h3><a href="detail.html">Gallo 03</a></h3>
                                    <p class="price"><del>S/130.00</del> S/100.00</p>
                                    <p class="buttons">
                                        <a href="detail.html" class="btn btn-default">Ver Detalles</a>
                                        <a href="basket.html" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Agregar</a>
                                    </p>
