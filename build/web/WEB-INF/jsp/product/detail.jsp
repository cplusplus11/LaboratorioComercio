...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 ...
 _________________________________________________________ -->
                    ...
                    <div class="banner">
                        <a href="#">
                            <img src="${pageContext.servletContext.contextPath}/assets/img/banner.jpg" alt="sales 2014" class="img-responsive">
                        </a>
                    </div>
                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="box">
                                ...
                                <p class="text-center buttons">
                                    ...
                                    <a href="" class="btn btn-default"><i class="fa fa-heart"></i> Deseados</a>
                                </p>
